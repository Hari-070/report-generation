...
export default function HomePage() {
  ...
  const [form, setForm] = useState<FormData>({ name: '', phone: '', email: '', score: '' });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isNaN(score) || score < 100 || score > 1000) return setError('Score must be between 100 and 1000.');
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm font-semibold text-white leading-tight">PRYSM Scanner</div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 animate-fade-up animate-fade-up-1">
              <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5">
                ...
                <span className="text-xs text-white/60 tracking-wide">Antioxidant Scan Report</span>
              </div>
              ...
              <p className="text-white/50 text-lg leading-relaxed">
                Enter the client's scan results below to instantly generate an AI-powered antioxidant health report — ready to download or email.
              </p>
              ...
              <div className="grid grid-cols-5 gap-2 pt-2">
                {[
                  ...
                  <div key={item.label} className="text-center">
                    ...
                    />
                    <div className="text-[10px] text-white/40">{item.range}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="animate-fade-up animate-fade-up-2">
              <div className="relative">
                ...
                <div className="relative bg-[#0d1424] border border-white/10 rounded-2xl p-8 shadow-2xl">
                  <h2 className="text-lg font-semibold mb-6 text-white/90">Client Details</h2>
                      ...
                      <div className="relative">
                        ...
                        {scoreInfo && (
                          <div
                            ...
                            style={{ backgroundColor: scoreInfo.hex + '20', color: scoreInfo.hex }}
                          >
                            <div className="w-2 h-2 rounded-full" style={{ backgroundColor: scoreInfo.hex }} />
                            {scoreInfo.label}
                          </div>
                        )}
                      </div>
                        ...
                        <div className="mt-3">
                          <div className="h-1.5 rounded-full score-track relative overflow-hidden">
                            <div
                              ...
                              style={{ width: `${100 - ((scoreNum - 100) / 900) * 100}%` }}
                            />
                          </div>
